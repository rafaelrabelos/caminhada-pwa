window.attachGoogleLogin = () => {
  gapi.load('auth2', () => {
    ...
    gLoginAttachToClickHandler(auth2, inputElement, gLoginOnSuccess, gLoginOnError);
  });
}

gLoginInitAuth = () => gapi.auth2.init({
...
gLoginOnSuccess = () => { console.log('No login success action');}
gLoginOnError = () => { console.log('No login error action');}